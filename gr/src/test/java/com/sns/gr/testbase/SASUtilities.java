...
//		System.out.println(query);
	...
	public void get_offer(WebDriver driver, String env, String brand, String campaign, String ppid, String category) throws ClassNotFoundException, SQLException, InterruptedException {		
	...
	public void select_kit(WebDriver driver, Map<String, Object> offerdata, String brand, String campaign) throws ClassNotFoundException, SQLException, InterruptedException {
		...
		if((brand.equalsIgnoreCase("Volaire")) && (campaign.equalsIgnoreCase("pnlb"))) {
			jse.executeScript("window.scrollBy(0,600)", 0);
		}
			
		if(brand.equalsIgnoreCase("Theraworx")) {
...
//		}
		...
		if(brand.equalsIgnoreCase("CrepeErase")){
			if((campaign.equalsIgnoreCase("Core")) || (campaign.equalsIgnoreCase("core_full_10sfwand")) || (campaign.equalsIgnoreCase("core_full_10neck"))) {
				jse.executeScript("window.scrollBy(0,700)", 0);
			}
			else if(campaign.equalsIgnoreCase("crepeerase")) {
				jse.executeScript("window.scrollBy(0,1800)", 0);
			}
			Thread.sleep(3000);
		}
...
//			System.out.println(gift_elmt.isDisplayed());
		...
		if((brand.equalsIgnoreCase("CrepeErase")) && ((campaign.equalsIgnoreCase("Core")) || (campaign.equalsIgnoreCase("core_full_10neck")) || (campaign.equalsIgnoreCase("core_full_10sfwand")) || (campaign.equalsIgnoreCase("deluxe20offtv")) || (campaign.equalsIgnoreCase("20offDeluxeSpring")))) {
			jse.executeScript("window.scrollBy(0,200)", 0);
			driver.findElement(By.xpath("//div[@class = 'sas-sticky-footer']//a[contains(text(),'Proceed to Checkout')]")).click();
		}
...
//	}	
	...
	public void select_fragrance(WebDriver driver, Map<String, Object> offerdata, String brand, String campaign) throws ClassNotFoundException, SQLException, InterruptedException {
		...
		if((!(fragrance.equalsIgnoreCase("n/a")))  && (!(fragrance.equals(" ")))){
			...
			else if(((brand.contains("CrepeErase")) || (brand.equalsIgnoreCase("BodyFirm"))) && ((category.equalsIgnoreCase("Product")) || (category.equalsIgnoreCase("ShopKit")))){
				Select sel_element = new Select(driver.findElement(By.xpath("//ul[@class='variations-section clearfix']//li//div[3]//select")));
				sel_element.selectByVisibleText(offerdata.get("FRAGRANCE").toString());
			}
...
//	}
	...
	public void select_product(WebDriver driver, Map<String, Object> offerdata, String brand, String campaign) throws ClassNotFoundException, SQLException, InterruptedException {
		...
		else if(((brand.equalsIgnoreCase("CrepeErase")) && (campaign.equalsIgnoreCase("Core"))) || (brand.contains("BodyFirm"))){
			Actions act = new Actions(driver);
			act.moveToElement(prod_elmt).perform();
			Thread.sleep(1000);
